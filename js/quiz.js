...
function form_template(numb,question,options){
            ...
            form.innerHTML = `
             ...
             <div class="form-check">
                 <input class="form-check-input radio_btn_input" type="radio" name="q" id="flexRadioDefault1" value="a">
                 <label class="form-check-label radio_btn" for="flexRadioDefault1">
                    ${options[0]}
                 </label>
               </div>
               <div class="form-check">
                 <input class="form-check-input radio_btn_input" type="radio" name="q" id="flexRadioDefault2" value="b" checked>
               ...
               <div class="form-check">
                 <input class="form-check-input radio_btn_input" type="radio" name="q" id="flexRadioDefault2" value="c">
                 <label class="form-check-label radio_btn" for="flexRadioDefault2">
                    ${options[2]}
                 </label>
               </div> 
               ...
               <div class="form-check">
                 <input class="form-check-input radio_btn_input" type="radio" name="q" id="flexRadioDefault2" value="d">
                 <label class="form-check-label radio_btn" for="flexRadioDefault2">
                   ${options[3]}
                 </label>
               </div> 
